...
The Settings section shows the market price next to both derived numbers —
if the "Market price" figure already looks like a retail price rather than a market
...
It deliberately does not fall back to the raw market price, because a market
price shown under "Consumption price" is wrong by the whole of your network
costs and VAT and looks completely reasonable. Retype the formula on the
Settings page; it is checked before it is saved, so a formula that saves is a
formula that works.
